angular.module('plantsApp', []).controller('PlantCtrl', function($scope, $http){
	...
	$http({
		method: 'GET',
		url: 'http://192.168.178.180:8080/plant/all',
		headers: {
	...
	$http({
		method: 'GET',
		url: 'http://192.168.178.180:8080/plant/0/',
		headers: {
			'Content-Type':'application/json',
			'Authorization': 'basic' + auth
		}
	...
	$http({
		method: 'GET',
		url: 'http://192.168.178.180:8080/plant/0/humidity',
		headers: {
			'Content-Type':'application/json',
			'Authorization': 'basic' + auth
		}
	...
	$scope.water = function() {
		$http({
			method: 'GET',
			url: 'http://192.168.178.180:8080/plant/0/water',
			headers: {
				'Content-Type':'application/json',
				'Authorization': 'basic' + auth
			}
